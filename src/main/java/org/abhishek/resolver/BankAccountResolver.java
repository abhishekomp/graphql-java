...
import org.abhishek.domain.bank.Client;
...
public class BankAccountResolver implements GraphQLQueryResolver {
    public BankAccount bankAccount(UUID id){
        ...
        return BankAccount.builder().id(id).currency(Currency.CHF).client(Client.builder().firstName("John").lastName("Doe").build()).build();
    }
}
